function [Clear_Used, Clear_Unused, ISE, IAE, IATE, MSE, RMSE, IADU, ITSE, ISTE, ITDE, ST, RT, MD, OS] = Clear_Output(Used, Unused, ISE, IAE, IATE, MSE, RMSE, IADU, ITSE, ISTE, ITDE, ST, RT, MD, OS)
